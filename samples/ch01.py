...
if __name__ == '__main__':
    ...
    old_webhook = 'https://oapi.dingtalk.com/robot/send?access_token=586ee7f196a26c3e84446038684f8c0d9962f4e609da63f2a54a239cc01b050a'
    ...
    # xiaoding = DingtalkChatbot(old_webhook, pc_slide=True, fail_notice=False)

    # text
    # xiaoding.send_text(msg='监控:我就是小丁，小丁就是我！')
    ...
    #
    # # FeedCard类型
    # card1 = CardItem(title="监控:氧气美女", url="https://www.baidu.com/", pic_url="http://pic1.win4000.com/wallpaper/2020-03-11/5e68b0557f3a6.jpg")

...
class TestDingtalk(unittest.TestCase):
    ...
    def test_text(self):
        """测试发送文本消息函数"""
        result = self.client.text(msg='[监控]我就是小丁，小丁就是我！', at_all=True)
    ...
    def test_link(self):
        """测试发送链接消息函数"""
        result = self.client.link(title='[监控]万万没想到，某小璐竟然...', text='故事是这样子的...', message_url='http://www.kwongwah.com.my/?p=454748', pic_url='https://pbs.twimg.com/media/CEwj7EDWgAE5eIF.jpg')
        self.assertEqual(result['errcode'], 0)

    def test_markdown(self):
        """测试发送Markdown格式消息函数"""
        result = self.client.markdown(title='[监控]氧气文字', text='#### 广州天气\n'
    ...
    def test_actioncard(self):
        ...
        actioncard1 = ActionCard(title='[监控]万万没想到，竟然...',
    ...
    def test_actioncard_old_api(self):
        ...
        actioncard2 = ActionCard(title='[监控]万万没想到，竟然...',
                                 text='![markdown](http://www.songshan.es/wp-content/uploads/2016/01/Yin-Yang.png) \n### 故事是这样子的...',
                                 btns=btns2,
                                 btn_orientation=1,
                                 hide_avatar=1)
    ...
    def test_feedcard(self):
        ...
        carditem1 = CardItem(title="[监控]氧气美女", url="https://www.dingtalk.com/", pic_url="http://pic1.win4000.com/wallpaper/2020-03-11/5e68b0557f3a6.jpg")
        carditem2 = CardItem(title="[监控]氧眼美女", url="https://www.dingtalk.com/", pic_url="http://pic1.win4000.com/wallpaper/2020-03-11/5e68b0557f3a6.jpg")
        carditem3 = CardItem(title="[监控]氧神美女", url="https://www.dingtalk.com/", pic_url="http://pic1.win4000.com/wallpaper/2020-03-11/5e68b0557f3a6.jpg")
    ...
    def test_feedcard_old_api(self):
        ...
        feedlink1 = FeedLink(title="[监控]氧气美女", message_url="https://www.dingtalk.com/", pic_url="http://pic1.win4000.com/wallpaper/2020-03-11/5e68b0557f3a6.jpg")
        feedlink2 = FeedLink(title="[监控]氧眼美女", message_url="https://www.dingtalk.com/", pic_url="http://pic1.win4000.com/wallpaper/2020-03-11/5e68b0557f3a6.jpg")
        feedlink3 = FeedLink(title="[监控]氧神美女", message_url="https://www.dingtalk.com/", pic_url="http://pic1.win4000.com/wallpaper/2020-03-11/5e68b0557f3a6.jpg")
